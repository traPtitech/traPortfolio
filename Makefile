...
db-gen-docs:
	...
	DB_HOST=localhost KNOQ_COOKIE=test KNOQ_API_ENDPOINT=test TRAQ_COOKIE=test TRAQ_API_ENDPOINT=test PORTAL_COOKIE=test PORTAL_API_ENDPOINT=test DB_PORT=$(TEST_DB_PORT) go run main.go -migrate true

...
// Source: usecases/repository/knoQ_repository.go
...
func (m *MockKnoqRepository) GetAll() ([]*repository.KnoQEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll")
	ret0, _ := ret[0].([]*repository.KnoQEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockKnoqRepository) GetByID(id uuid.UUID) (*repository.KnoQEvent, error) {
	m.ctrl.T.Helper()

	...
	}{
		{
			...
			args: args{
				...
				args: &repository.UpdateProjectArgs{
					...
					SinceYear:     optional.New(int64(duration.Since.Year), true),
					SinceSemester: optional.New(int64(duration.Since.Semester), true),
					UntilYear:     optional.New(int64(duration.Until.Year), true),
					UntilSemester: optional.New(int64(duration.Until.Semester), true),
				},
			},
			setup: func(repo *mock_repository.MockProjectRepository, args args) {
		...
		},
		{
			...
			args: args{
				...
				args: &repository.UpdateProjectArgs{
					...
					Description:   random.OptAlphaNumeric(),
					Link:          random.OptAlphaNumeric(),
					SinceYear:     optional.New(int64(duration.Until.Year), true),
					SinceSemester: optional.New(int64(duration.Until.Semester), true),
					UntilYear:     optional.New(int64(duration.Since.Year), true),
					UntilSemester: optional.New(int64(duration.Since.Semester), true),
				},
			},
			setup: func(repo *mock_repository.MockProjectRepository, args args) {
				repo.EXPECT().GetProject(args.id).Return(&domain.ProjectDetail{

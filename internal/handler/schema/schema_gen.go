...
type AddContestTeamRequest struct {
	...
	// Links コンテストチームのリンク集
	Links []ContestTeamLink `json:"links"`
...
// ContestLink コンテストの詳細が載っているページへのリンク
type ContestLink = string
...
// ContestTeamLink コンテストチームの詳細が載っているページへのリンク
type ContestTeamLink = string
...
type EditContestRequest struct {
	...
	// Links コンテストのリンク集
	Links *[]ContestLink `json:"links,omitempty"`
...
type EditContestTeamRequest struct {
	...
	// Links コンテストチームのリンク集
	Links *[]ContestTeamLink `json:"links,omitempty"`
...
// GroupLink 班の詳細が載っているページへのリンク
type GroupLink = string
...
// ProjectLink プロジェクトの詳細が載っているページへのリンク
type ProjectLink = string
